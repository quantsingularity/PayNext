/*! For license information please see main.c1698df1.js.LICENSE.txt */
(() => {
  var e = {
      854: (e, t, n) => {
        e.exports = n(672);
  ...
  ((n.m = e),
    ...
    (n.u = (e) => "static/js/" + e + ".66730c70.chunk.js"),
    (n.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self.webpackChunkpnx_frontend =
          self.webpackChunkpnx_frontend || []);
    ...
    (() => {
      ...
      function g(e, t, n, r) {
        let a = T(("string" === typeof t ? p(t) : t).pathname || "/", n);
        ...
        for (let i = 0; i < r.length; ++i) {
          ...
          (Object.assign(a, c.params),
            o.push({
              ...
              pathnameBase: U(F([l, c.pathnameBase])),
              route: f,
            }),
      ...
      const Se =
        ...
        Ee = t.forwardRef(function (e, n) {
          let r,
            ...
            g = !1;
          if ("string" === typeof f && xe.test(f) && ((r = f), Se))
            try {
          ...
          let y = (function (e, n) {
              ...
              let { basename: a, navigator: l } = t.useContext(Q),
                { hash: o, pathname: i, search: s } = ee(e, { relative: r }),
                c = i;
              return (
                "/" !== a && (c = "/" === i ? a : F([a, i])),
      ...
      var Pe = n(854),
        Ne = n.n(Pe);
      const Re = "https://api.yourdomain.com/auth/",
        Oe = {
          login: async (e, t) => {
            const n = await Ne().post(`${Re}login`, { email: e, password: t });
            return (
          ...
          register: async (e, t) => {
            const n = await Ne().post(`${Re}register`, {
              email: e,
              password: t,
            });
            return (
      ...
      const Le = () => {
          ...
          return (0, Te.jsxs)("div", {
            ...
            children: [
              ...
              l && (0, Te.jsx)("p", { style: { color: "red" }, children: l }),
              (0, Te.jsxs)("form", {
                onSubmit: async (t) => {
                  t.preventDefault();
                  try {
                    (await Oe.login(e, r), i("/dashboard"));
                  } catch (n) {
                ...
                children: [
                  ...
                  (0, Te.jsxs)("div", {
                    children: [
                      (0, Te.jsx)("label", { children: "Password:" }),
                      (0, Te.jsx)("input", {
                        type: "password",
                        value: r,
                  ...
                  (0, Te.jsx)("button", { type: "submit", children: "Login" }),
                ],
              }),
            ],
          });
        ...
        ze = () => {
          ...
          return (0, Te.jsxs)("div", {
            className: "container",
            children: [
              (0, Te.jsx)("h2", { children: "Register" }),
              i && (0, Te.jsx)("p", { style: { color: "red" }, children: i }),
              (0, Te.jsxs)("form", {
                onSubmit: async (t) => {
                  if ((t.preventDefault(), r === l))
                    try {
                      (await Oe.register(e, r), s("/dashboard"));
                    } catch (n) {
                ...
                children: [
                  ...
                  (0, Te.jsxs)("div", {
                    children: [
                      (0, Te.jsx)("label", { children: "Confirm Password:" }),
                      (0, Te.jsx)("input", {
                        type: "password",
                        value: l,
        ...
        je = () =>
          (0, Te.jsxs)("div", {
            className: "container",
            children: [
              (0, Te.jsx)("h2", { children: "Dashboard" }),
              (0, Te.jsx)("p", { children: "Welcome to your dashboard!" }),
              (0, Te.jsxs)("div", {
                children: [
                  (0, Te.jsx)(Ee, {
                    to: "/payments/new",
                  ...
                  (0, Te.jsx)(Ee, {
                    to: "/profile",
                    children: (0, Te.jsx)("button", { children: "Profile" }),
                  }),
                ],
              }),
            ],
          }),
        De = "https://api.yourdomain.com/payments/",
        Fe = {
        ...
        Ue = () => {
          ...
          return (0, Te.jsxs)("div", {
            className: "container",
            children: [
              (0, Te.jsx)("h2", { children: "New Payment" }),
              l && (0, Te.jsx)("p", { style: { color: "green" }, children: l }),
              i && (0, Te.jsx)("p", { style: { color: "red" }, children: i }),
              (0, Te.jsxs)("form", {
                onSubmit: async (t) => {
                  t.preventDefault();
                  try {
                    (await Fe.createPayment({ amount: e, description: r }),
                ...
                children: [
                  (0, Te.jsxs)("div", {
                    children: [
                      (0, Te.jsx)("label", { children: "Amount:" }),
                      (0, Te.jsx)("input", {
                        type: "number",
                        value: e,
                        onChange: (e) => n(e.target.value),
                  ...
                  (0, Te.jsxs)("div", {
                    children: [
                      (0, Te.jsx)("label", { children: "Description:" }),
                      (0, Te.jsx)("input", {
                        type: "text",
                        value: r,
                        onChange: (e) => a(e.target.value),
        ...
        Me = () => {
          ...
          return (
            (0, t.useEffect)(() => {
              (async () => {
                try {
                  const e = await Fe.getPaymentHistory();
                  n(e);
                } catch (e) {
            ...
            (0, Te.jsxs)("div", {
              className: "container",
              children: [
                (0, Te.jsx)("h2", { children: "Payment History" }),
                r && (0, Te.jsx)("p", { style: { color: "red" }, children: r }),
                (0, Te.jsx)("ul", {
                  children: e.map((e) =>
                    (0, Te.jsxs)(
                      "li",
        ...
        Ie = "https://api.yourdomain.com/users/",
        Ae = {
          getUserProfile: async () =>
            (
              await Ne().get(`${Ie}profile`, {
                headers: {
                  Authorization: `Bearer ${localStorage.getItem("user")}`,
                },
              })
        ...
        Be = () => {
          ...
          (0, t.useEffect)(() => {
            (async () => {
              try {
                const e = await Ae.getUserProfile();
                n(e);
              } catch (e) {
          ...
          return (0, Te.jsx)(ke, {
            children: (0, Te.jsx)("div", {
              ...
              children: (0, Te.jsxs)(me, {
                children: [
                  (0, Te.jsx)(pe, { path: "/", element: (0, Te.jsx)(Le, {}) }),
                  (0, Te.jsx)(pe, {
                    path: "/register",
                    element: (0, Te.jsx)(ze, {}),
                  }),
      ...
      (a.render(
        (0, Te.jsx)(t.StrictMode, { children: (0, Te.jsx)($e, {}) }),
        document.getElementById("root"),
      ),
        We());
    })());
})();
//# sourceMappingURL=main.c1698df1.js.map
